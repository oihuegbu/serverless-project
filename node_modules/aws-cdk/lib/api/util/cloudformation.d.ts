...
export declare class CloudFormationStack {
     ...
     * Empty list if the stack does not exist
     */
    get notificationArns(): CloudFormation.NotificationARNs;
    /**
 ...
 */
export declare function createDiffChangeSet(options: PrepareChangeSetOptions): Promise<DescribeChangeSetOutput | undefined>;
/**
...
export declare function cleanupOldChangeset(changeSetName: string, stackName: string, cfn: CloudFormation): Promise<void>;
/**
